...
public class Movie
{
    ...
    [StringLength(100, ErrorMessage = "O Título deve possuir no máximo 100 carateres")]
    public string Title { get; set; }

    [Display(Name = "Título Original")]
    [Required(ErrorMessage = "O Título Original é obrigatório")]
    [StringLength(100, ErrorMessage = "O Título Original deve possuir no máximo 100 carateres")]
    public string TitleOriginal { get; set; }

    [Display(Name = "Sinopse")]
    [Required(ErrorMessage = "A Sinopse é obrigatória")]
    [StringLength(8000, ErrorMessage = "A Sinopse deve possuir no máximo 8000 carateres")]
